 ...
 */
const TARE_UPPER_BOUND_0_9_EVO = 6.592;
const TARE_LOWER_BOUND_0_9_EVO = 6.412; // 6.411
const TARE_UPPER_BOUND_0_5_PF = 5.278;
const TARE_LOWER_BOUND_0_5_PF = 5.111;
const TARE_UPPER_BOUND_0_3_PF = 14.168;
const TARE_LOWER_BOUND_0_3_PF = 13.761;
...
async function validateTareTolerance(tareIn) {
  ...
  if (process.env.CART_SIZE === '0.9') {
    return !((tareIn >= TARE_LOWER_BOUND_0_9_EVO) && (tareIn <= TARE_UPPER_BOUND_0_9_EVO));
  } else if (process.env.CART_SIZE === '0.5') {
    return !((tareIn >= TARE_LOWER_BOUND_0_5_PF) && (tareIn <= TARE_UPPER_BOUND_0_5_PF));
  } else if (process.env.CART_SIZE === '0.3') {
    return !((tareIn >= TARE_LOWER_BOUND_0_3_PF) && (tareIn <= TARE_UPPER_BOUND_0_3_PF));
  } else {
