...
function printCollectTares(trayNum, cellNum) {
  ...
  console.log();
  printMenuHeader();
  console.log(`  ${colorText('*', gray)}  ${colorText('*', red)} Tray: ${trayNum.padEnd(6, ' ')}            ${colorText('*', gray)}`);
  console.log(`  ${colorText('*', gray)}  ${colorText('*', red)} Cell: ${cellNum.padEnd(6, ' ')}            ${colorText('*', gray)}`);
  console.log(`  ${colorText('*', gray)}  ${colorText('*', red)} < blank >               ${colorText('*', gray)}`);
  console.log(`  ${colorText('*', gray)}  ${colorText('*', red)} < blank >               ${colorText('*', gray)}`);
  console.log(colorText(`  ------------------------------`, gray));
}
function printCollectGrosses(trayNum, cellNum, tare) {
  ...
  trayNum = String(trayNum);
  tare = String(tare);
  let po_id = String(process.env.QB_PO_ID)
  ...
  console.log(`  ${colorText('*', gray)}  ${colorText('*', red)} Tare: ${tare.padEnd(6, ' ')}            ${colorText('*', gray)}`);
  console.log(`  ${colorText('*', gray)}  ${colorText('*', red)} Prod: ${po_id.padEnd(6, ' ')}            ${colorText('*', gray)}`);
  console.log(colorText(`  ------------------------------`, gray));
}
function printGrossStats(currNetIn, percentErrorIn, inSpecIn, currTareIn) {
  currNetIn = String(currNetIn) + ' g';
  currTareIn = String(currTareIn) + ' g';
  ...
  console.log(colorText(`  ------------------------------`, accent));
  console.log(`  ${colorText('*', accent)}  ${colorText('*', accent)} Net:     ${currNetIn.padEnd(5, ' ')}     ${colorText('*', accent)}  ${colorText('*', accent)}`);
  console.log(`  ${colorText('*', accent)}  ${colorText('*', accent)} P_Err:   ${percentErrorIn.padEnd(10, ' ')}  ${colorText('*', accent)}  ${colorText('*', accent)}`);
  console.log(`  ${colorText('*', accent)}  ${colorText('*', accent)} In_Spec: ${colorText(inSpecInStr.padEnd(5, ' '), accent)}       ${colorText('*', accent)}  ${colorText('*', accent)}`);
  console.log(`  ${colorText('*', accent)}  ${colorText('*', accent)} Tare:    ${currTareIn.padEnd(8, ' ')}    ${colorText('*', accent)}  ${colorText('*', accent)}`);
  console.log(colorText(`  ------------------------------`, accent));
}
