...
function createBody(trayNum, cellNum) {
  const trayArgs = {
    trayNum,
    cellNum,
    relProdOrd: 17767, // manually enter Record ID
    relProdMaster: 275, // manually enter Record ID
    relMMR: 6, // manually enter Record ID
