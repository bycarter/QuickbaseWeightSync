...
const grossTemplateJSON = {
  "to": '{{tableID}}',
  "data": [
    { "6": { "value": '{{trayNum}}' },
      "7": { "value": '{{cellNum}}' },
      "8": { "value": '{{tare}}' }, // tare_weight
      "9": { "value": '{{gross}}' }, // gross_weight
      "13": { "value": '{{relProdOrd}}' },
...
const correctedGrossTemplateJSON = {
  "to": '{{tableID}}',
  "data": [
    { "6": { "value": '{{trayNum}}' },
      "7": { "value": '{{cellNum}}' },
      "8": { "value": '{{tare}}' }, // tare_weight
      "9": { "value": '{{gross}}' }, // gross_weight
      "25":{ "value": '{{cGross}}' }, // corrected_gross_weight
      "13": { "value": '{{relProdOrd}}' },
      "16": { "value": '{{relProdMaster}}' },
      "20": { "value": '{{relMMR}}' },
    }
